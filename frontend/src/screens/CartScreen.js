...
function CartScreen(props) {
    ...
    const qty = props.location.search? Number(props.location.search.split("=")[1]) : 1;   //split to take right side of qty = number
    ...
    },[]) //empty array means only run this command after rendering done in the cart screen
